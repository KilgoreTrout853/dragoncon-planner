...
import { dayOf, esc, fmt, fmtMins, fmtShort, minutesBetween, toDate } from "./util.js";
...
/* What is left of the test surface: the functions and consts still in this
   ...
   replaces. */
export {
  activeFilters, browseResults, closeSheet, edgeTouchMove, edgeTouchStart, expandQuery,
  hiddenForQueryHTML, hideUpdatePill, indexReady, layoutColumns, mapCardHTML, mapDay,
  markActiveSection, nowModel, nowSignature, nudgeCopy, openExplorePage, openSheet, pageScrollBy,
  pageScrollTo, parseQuery, pickActiveSection, queueBrowseRender, readExploreHash,
  recheckSchedule, render, renderBrowse, renderExplore, renderMap, renderMiniBar, renderNotice,
  renderNow, revealChip, setDrag, setExploreHash, setTimeOverride, showUpdatePill,
  suggestionsFor, termQuality, tickMap, tickNow, togglePick, updateClock, updateFresh,
