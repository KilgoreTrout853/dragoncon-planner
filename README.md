...
| `tests/` | 22 parser tests and 474 UI assertions. Not optional — run them before you push. |
...
node tests/ui_smoke.js           # 474 assertions
python tests/test_parse.py       # 22 parser tests
```
